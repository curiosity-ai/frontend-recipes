...
using Curiosity.FrontEnd.Recipes.Recipes._01_HelloWorld;
using Curiosity.FrontEnd.Recipes.Recipes._02_SearchArea;
using Curiosity.FrontEnd.Recipes.Recipes._03_Pivot;
using Curiosity.FrontEnd.Recipes.Recipes._04_SegmentedPivot;
using Curiosity.FrontEnd.Recipes.Recipes._05_NodeRenderer;
using Curiosity.FrontEnd.Recipes.Recipes._06_NeighborsGraph;
using Curiosity.FrontEnd.Recipes.Recipes._07_Dashboard;
using Curiosity.FrontEnd.Recipes.Recipes._08_CustomChat;
using Curiosity.FrontEnd.Recipes.Recipes._09_Sidebar;
using Curiosity.FrontEnd.Recipes.Recipes._10_UserPreferences;
using Tesserae;
